...
extract($_GET);
?>
<script src="/alumniTracer/js/form-builder.js"></script>
...
var currentpage = `<?php include_once $_SERVER['DOCUMENT_ROOT']."/AlumniTracer/forms/".$code.".xml" ?>`;
...
function  EditFuction(){
        ...
        start_loader()
        $.ajax({
            url: "/AlumniTracer/classes/Forms.php?a=save_form",
            method: 'POST',
